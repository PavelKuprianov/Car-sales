...
<html lang="ru">
  ...
  <body>
    ...
    <div class="block">
      ...
      $res = mysqli_query($db, "SELECT * FROM auto WHERE `id_auto` = $idCar");
      ...
      ?>
        ...
        <section class="access container">
            <div class="once-car">
                <h2 class="title-brend-once"><?php echo $currentAuto[1]; ?></h2>
                <div class="once-car_img">
                    <img src=" <?php echo $currentAuto[2]; ?>" alt="">
                </div>
                <h3 class="title-inform-once">Основные характеристики: <?php echo $currentAuto[4]; ?></h3>
                <h3 class="title-inform-once">Ключевые геометрические параметры: <?php echo $currentAuto[5]; ?></h3>
                <h4 class="title-price-once">Цена: от <?php echo $currentAuto[6]; ?> рублей</h4>
                <p class="once-text"><?php echo $currentAuto[7]; ?></p>
                <p class="once-text">Год выпуска автомобиля: <?php echo $currentAuto[8]; ?></p>
            </div>
