...
<html lang="ru">
  ...
  <body>
    ...
    <div class="block">
      ...
      $res = mysqli_query($db, "SELECT * FROM brend");
...
//      print_arr($currentArr);
      $resAuto = mysqli_query($db, "SELECT * FROM auto WHERE `id_brend` = $currentArr[0]");
      ...
      ?>
        ...
        <section class="access container">
            ...
            <h3 class="country">Страна-производитель: <?php echo $currentArr[3]; ?></h3>
...
<!--                    <section class="modal-car">-->
<!--                        <div class="modal-wrap-car">-->
<!--                            <div class="close-modal-car"><img class="close-modal-img-car" src="../img/close-modal.svg" alt="Закрыть"></div>-->
<!--                            <h2 class="modal-title">--><?php //echo $values[1]; ?><!--</h2>-->
<!---->
<!---->
<!---->
<!--                            <img src = "--><?php //echo $values[2]; ?><!--" alt = "Фото автомобиля" >-->
